  ...
  return (
    ...
    >
      <Heading className="text-2xl sm:text-3xl font-bold text-gray-900 mt-8 mb-6 leading-tight break-words">
        Ugens nyheder om erhvervsejendomme
      </Heading>
      ...
      <Text className="text-base text-gray-700 my-4 leading-relaxed break-words">
        Her er ugens vigtigste nyheder inden for den danske
        erhvervsejendomsbranche ({weekStart} - {weekEnd}):
      </Text>
      ...
      <Text className="text-sm text-gray-500 my-6 text-center leading-relaxed break-words">
        Du modtager denne ugentlige oversigt baseret på dine præferencer. Du kan
        til enhver tid ændre dine indstillinger eller afmelde dig.
      </Text>
      ...
      >
        Se alle artikler på Estate News
      </Button>
    </EmailLayout>
  );
};
